...
from .views import CustomTokenObtainPairView, ManageCVView, RegisterView, GoogleLoginView, SaveOnboardingView, SavedVacancyDestroyView, SavedVacancyListCreateView
