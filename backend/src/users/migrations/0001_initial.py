# Generated by Django 5.2.14 on 2026-05-24 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.CharField(blank=True, choices=[('junior', 'Junior'), ('middle', 'Middle'), ('senior', 'Senior'), ('lead', 'Lead / Expert')], db_index=True, max_length=20, null=True)),
                ('salary', models.IntegerField(blank=True, db_index=True, null=True)),
